...
export function ChatWindow({ conversationId, onClose }: ChatWindowProps) {
  ...
  return (
    <div className="fixed bottom-0 right-0 w-full h-[calc(100vh-4rem)] sm:w-95 sm:h-150 sm:bottom-6 sm:right-6 bg-gray-100 dark:bg-gray-900 rounded-lg shadow-xl flex flex-col overflow-hidden transition-all duration-300 ease-in-out">
      ...
      <div className="flex-1 overflow-y-auto p-4 bg-gray-50 dark:bg-gray-600 transition-all duration-300 ease-in-out max-h-[calc(100vh-12rem)]">
      ...
      <div className="bg-[#f0f2f5] dark:bg-gray-800 p-3 transition-all duration-300 ease-in-out max-h-20">
